...
export async function POST(request: Request) {
    try {
        ...
        // The shadow reflection question is in the supportingQuote field
        const shadowQuestion = supportingQuote;

        // Create a specialized prompt for individual shadow trait integration
        ...
        console.error('Error in individual shadow reflection API:', error);
        return NextResponse.json(
